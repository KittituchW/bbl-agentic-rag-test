...
def build_agents(model: OpenAIResponsesModel) -> Agent:
    ...
    report_generator = Agent(
        ...
        instructions=(
            ...
            "some of them, answer those parts and state plainly which parts "
            ...
            "Group bullets under short headings when the question has "
            "distinct parts. Lead with the direct answer — if the knowledge "
            "base does not cover the question, or cannot be used the way the "
            "question asks, say so in the FIRST line, not the last.\n"
